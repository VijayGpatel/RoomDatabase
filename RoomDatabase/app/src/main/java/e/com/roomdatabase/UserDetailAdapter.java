    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.imgDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((BaseActivity) mcontext).roomDatabase.userDetailDAO().deleteByUserId(userDetails.get(position).getId());
            ...
            public void onClick(View view) {
                ...
                btnUpdate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ((BaseActivity) mcontext).roomDatabase.userDetailDAO().updateUserDetailById(userDetails.get(position).getId(), edtName.getText().toString(), edtEmail.getText().toString(), edtPhone.getText().toString(), edtCity.getText().toString(), edtState.getText().toString());
